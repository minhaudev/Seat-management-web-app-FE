...
//                 const expireAt = new Date(assign.temporaryTime!).getTime();
...
//     // Giả sử bạn gọi hàm này khi assign user tạm thời:
//     const assignTempSeat = (seatId: string, duration: number) => {
//         setSeatTimes((prev) => ({...prev, [seatId]: duration}));
//     };
